...
public class ContractNumberController {
    ...
    public ResponseEntity<Optional<ContractNumber>> updateWithCheck(@PathVariable(name = "id") Integer id, @RequestBody ContractNumberUpdateDto contractNumberUpdateDto) {
        Optional<ContractNumber> contractNumber = contractNumberDatabaseService.updateWithCheck(id, contractNumberUpdateDto);
        return ResponseEntity.ok(contractNumber);
    }

    @DeleteMapping(value = "/contract/delete/{id}")
    public ResponseEntity<Integer> delete(@PathVariable Integer id) {
        contractNumberDatabaseService.delete(id);
